...
`,(0,t.jsx)(n.li,{children:`Added a loading screen on app startup`}),`
`,(0,t.jsx)(n.li,{children:`Added light mode`}),`
`,(0,t.jsx)(n.li,{children:`Added persistent search filters (search state will remain even if you visit another page, including tags and search query)`}),`
`]})}),`
...
`,(0,t.jsx)(n.li,{children:`Added an auto-updater (toggleable in settings)`}),`
...
`,(0,t.jsxs)(n.li,{children:[`Updated tagging for maps (Level of Detail / Source Quality) to replace ambiguous high/medium/low-detail (see the `,(0,t.jsx)(n.a,{href:`/railyard/docs/latest/data-quality`,children:`Data Quality guide`}),`)`]}),`
`]})]}),`
`,(0,t.jsx)(r,{type:`bugfixes`,children:(0,t.jsxs)(n.ul,{children:[`
`,(0,t.jsx)(n.li,{children:`Fixed installed assets not being displayed on initial load-in`}),`
`,(0,t.jsx)(n.li,{children:`Fixed multiple parallel downloads sometimes leading to crashes`}),`
`,(0,t.jsx)(n.li,{children:`Fixed download counts displaying total downloads for all assets for a release (rather than just the asset ZIP)`}),`
`,(0,t.jsx)(n.li,{children:`Fixed maps having a download count of 0`}),`
`,(0,t.jsx)(n.li,{children:`Fixed an issue where updating Railyard would delete all installed content`}),`
