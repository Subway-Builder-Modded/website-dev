...
`,(0,t.jsx)(n.li,{children:`Added an uninstall button for maps/mods`}),`
`]})}),`
`,(0,t.jsx)(r,{type:`improvements`,children:(0,t.jsxs)(n.ul,{children:[`
`,(0,t.jsx)(n.li,{children:`Replaced parallel downloads with a download queue`}),`
`,(0,t.jsxs)(n.li,{children:[`Added checks for `,(0,t.jsx)(n.code,{children:`manifest.json`}),` in mod ZIP files`]}),`
`]})}),`
`,(0,t.jsx)(r,{type:`bugfixes`,children:(0,t.jsxs)(n.ul,{children:[`
`,(0,t.jsx)(n.li,{children:`Removed population as a sort option for mods`}),`
