import{t as e}from"./jsx-runtime-qJqhvtml.js";var t=e();function n(e){let n={code:`code`,li:`li`,strong:`strong`,ul:`ul`,...e.components},{ChangelogSection:r}=n;return r||i(`ChangelogSection`,!0),(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(r,{type:`features`,children:(0,t.jsxs)(n.ul,{children:[`
`,(0,t.jsxs)(n.li,{children:[`Added update indicators to `,(0,t.jsx)(n.strong,{children:`Library`}),` if an asset's version is outdated`]}),`
`,(0,t.jsx)(n.li,{children:`Multiple assets can be updated at once via selection`}),`
`,(0,t.jsxs)(n.li,{children:[`Added a new theme switcher to `,(0,t.jsx)(n.strong,{children:`Settings`}),` and 6 new themes: `,(0,t.jsx)(n.code,{children:`Dark`}),`, `,(0,t.jsx)(n.code,{children:`Dark (Soft)`}),`, `,(0,t.jsx)(n.code,{children:`Dark (Contrast)`}),`, `,(0,t.jsx)(n.code,{children:`Light`}),`, `,(0,t.jsx)(n.code,{children:`Light (Soft)`}),`, `,(0,t.jsx)(n.code,{children:`Light (Contrast)`})]}),`
`]})}),`
...
`,(0,t.jsx)(n.li,{children:`Removed the right-click context menu`}),`
`,(0,t.jsx)(n.li,{children:`Fixed pinching (on a touchscreen device) still allowing you to zoom`}),`
`,(0,t.jsxs)(n.li,{children:[`Fixed selecting multiple projects in `,(0,t.jsx)(n.strong,{children:`Library`}),` not clearing selection when deleting via the trash can`]}),`
...
`,(0,t.jsx)(n.li,{children:`The app now allows only one cancellation button to be present during install`}),`
