import{t as e}from"./jsx-runtime-qJqhvtml.js";var t=e();function n(e){let n={a:`a`,code:`code`,h3:`h3`,li:`li`,strong:`strong`,ul:`ul`,...e.components},{ChangelogSection:r}=n;return r||i(`ChangelogSection`,!0),(0,t.jsxs)(t.Fragment,{children:[(0,t.jsxs)(r,{type:`features`,children:[(0,t.jsx)(n.h3,{children:`UI Overhaul`}),(0,t.jsxs)(n.ul,{children:[`
...
`,(0,t.jsxs)(n.li,{children:[`Local maps are displayed on `,(0,t.jsx)(n.strong,{children:`Library`}),` with a `,(0,t.jsx)(n.strong,{children:`Local`}),` tag and are loaded alongside any Railyard-hosted maps`]}),`
`]}),(0,t.jsx)(n.h3,{children:`Profiles`}),(0,t.jsxs)(n.ul,{children:[`
`,(0,t.jsx)(n.li,{children:`Added support for multiple profiles`}),`
`,(0,t.jsx)(n.li,{children:`Individual profiles maintain separate sets of subscriptions and UI/System preferences`}),`
...
`,(0,t.jsx)(n.li,{children:`You can now enable Subway Builder DevTools in the Railyard settings`}),`
`]})]}),`
...
`,(0,t.jsxs)(n.li,{children:[(0,t.jsx)(n.strong,{children:`Browse`}),` now displays a brief loading screen to eliminate lag/slow loading behavior on startup`]}),`
`,(0,t.jsxs)(n.li,{children:[(0,t.jsx)(n.strong,{children:`Library`}),` now displays city code for all maps`]}),`
...
`,(0,t.jsxs)(n.li,{children:[`Fixed Ctrl+Click on an asset's `,(0,t.jsx)(n.strong,{children:`Browse`}),` card causing it to open up in an instanced browser window`]}),`
`,(0,t.jsx)(n.li,{children:`Fixed toast notifications being able to be picked up and moved around the screen`}),`
`,(0,t.jsxs)(n.li,{children:[`Command line argument insertion no longer replaces machine env when `,(0,t.jsx)(n.strong,{children:`DevTools`}),` is enabled`]}),`
