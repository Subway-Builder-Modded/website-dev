...
`,(0,t.jsx)(n.li,{children:`Added support for optional GitHub token to work around GitHub API limits`}),`
`]})}),`
...
`,(0,t.jsx)(n.li,{children:`All assets now show download counts on the Browse page, with maps also showing flag icons corresponding to the country of the map`}),`
`,(0,t.jsx)(n.li,{children:`Search now only show tags when an asset with that tag exists`}),`
...
`,(0,t.jsx)(n.li,{children:`Railyard now launches in fullscreen`}),`
`,(0,t.jsx)(n.li,{children:`Linux builds are now through Flatpak. This means you will need to have Flatpak installed in order for the app to function. In addition, this means the autoupdater will be broken for one patch on Linux (you will need to manually install the flatpak included in the v0.1.4 release yourself)`}),`
...
`,(0,t.jsx)(n.li,{children:`Fixed scrolling left and right/zooming in and out`}),`
...
`,(0,t.jsx)(n.li,{children:`Assets with no installable versions are hidden on the Browse page and individual versions that are not installable are hidden on the Install page`}),`
`]})}),`
