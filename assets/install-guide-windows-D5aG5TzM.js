...
`,(0,n.jsxs)(t.p,{children:[`To install Railyard on Windows, navigate to the `,(0,n.jsx)(t.a,{href:`https://subwaybuildermodded.com/railyard`,children:`download page`}),`. You should see a button with the auto-detected download for your operating system. You `,(0,n.jsx)(t.strong,{children:`must`}),` download the correct version for your system architecture (x64 or ARM64). Otherwise, the Railyard installer will not work.`]}),`
`,(0,n.jsx)(i,{children:(0,n.jsx)(t.p,{children:`On some Firefox-based browsers, ARM64 systems may be auto-detected as x64. If you have an ARM64 system, make sure to select the ARM64 version from the dropdown menu.`})}),`
`,(0,n.jsx)(s,{children:(0,n.jsxs)(t.p,{children:[`You will need administrative privileges to install Railyard on Windows. If you wish to install a portable version, you can find the `,(0,n.jsx)(t.strong,{children:`All Downloads`}),` section at the bottom of the download page. From there, select the version that matches your system architecture.`]})}),`
