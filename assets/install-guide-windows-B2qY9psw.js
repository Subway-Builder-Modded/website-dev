import{t as e}from"./jsx-runtime-qJqhvtml.js";var t=e();function n(e){let n={a:`a`,code:`code`,h2:`h2`,h3:`h3`,hr:`hr`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...e.components},{Alert:r,Caution:a,Image:o,Important:s,Note:c,Tip:l}=n;return r||i(`Alert`,!0),a||i(`Caution`,!0),o||i(`Image`,!0),s||i(`Important`,!0),c||i(`Note`,!0),l||i(`Tip`,!0),(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(n.p,{children:`This guide will walk you through installing and setting up Railyard on Windows-based systems.`}),`
`,(0,t.jsx)(n.h2,{id:`downloading-railyard`,children:`Step 1 - Downloading Railyard`}),`
`,(0,t.jsxs)(n.p,{children:[`To install Railyard on Windows, navigate to the `,(0,t.jsx)(n.a,{href:`https://subwaybuildermodded.com/railyard`,children:`download page`}),`. You should see a button with the auto-detected download for your operating system. You `,(0,t.jsx)(n.strong,{children:`must`}),` download the correct version for your system architecture (x64 or ARM64). Otherwise, the Railyard installer will not work.`]}),`
`,(0,t.jsx)(a,{children:(0,t.jsx)(n.p,{children:`On some Firefox-based browsers, ARM64 systems may be auto-detected as x64. If you have an ARM64 system, make sure to select the ARM64 version from the dropdown menu.`})}),`
`,(0,t.jsx)(s,{children:(0,t.jsxs)(n.p,{children:[`You will need administrative privileges to install Railyard on Windows. If you wish to install a portable version, you can find the `,(0,t.jsx)(n.strong,{children:`All Downloads`}),` section at the bottom of the download page. From there, select the version that matches your system architecture.`]})}),`
`,(0,t.jsx)(n.p,{children:`Install the app as you normally would any other app on Windows.`}),`
`,(0,t.jsx)(n.hr,{}),`
`,(0,t.jsx)(n.h2,{id:`setting-up-railyard`,children:`Step 2 - Setting Up Railyard`}),`
...
`,(0,t.jsx)(c,{children:(0,t.jsx)(n.p,{children:`Game executable refers to the actual file that launches the game, not any shortcut or folder containing it.`})}),`
`,(0,t.jsx)(n.h3,{id:`github-token`,children:`GitHub Token`}),`
`,(0,t.jsxs)(n.p,{children:[`The next prompt will ask you to input your GitHub token. This is optional, but `,(0,t.jsx)(n.strong,{children:`highly`}),` recommended to avoid hitting GitHub's API rate limits when using Railyard. If you do not have a token or do not wish to use one, simply click `,(0,t.jsx)(n.strong,{children:`Next`}),` to continue with the setup process. You can always add a token later via the settings menu.`]}),`
...
`,(0,t.jsx)(l,{children:(0,t.jsx)(n.p,{children:`It is recommended to keep this enabled to ensure you have the latest features and bug fixes. This can be toggled at any time via the settings menu.`})}),`
`,(0,t.jsx)(n.hr,{}),`
`,(0,t.jsx)(n.h2,{id:`launching-subway-builder`,children:`Step 3 - Launching Subway Builder`}),`
...
`,(0,t.jsx)(`p`,{align:`center`,children:(0,t.jsx)(o,{width:`500`,alt:`image`,src:`/images/railyard/docs/v0.1/install-guide-windows/mod-manager.png`})}),`
